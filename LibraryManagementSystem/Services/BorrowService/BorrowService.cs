public class BorrowService : IBorrowService
{
    ...
    {
        var borrowList = _borrowRepository.ViewAllBorrowLists();
        var borrowRecord = borrowList.FirstOrDefault(x => x.BookId == bookId && x.MemberId == memberId && x.Status == "Borrowed");
        ...
        if (bookDetails != null)
        {
            ...
            _bookRepository.UpdateBookCount(bookToUpdate);
        }

        _borrowRepository.ReturnBook(bookId, memberId);
    }
}
